...
public class Enigma1{
  public static void main(String []arg){
   ...
   percent = x/100;
   if(1-percent==0.93)  //when the user enters 7
      System.out.println("The proportion remaining is "+0.93);
    else if(1-percent==0.59)//when the user enters 41
      System.out.println("The proportion remaining is "+0.59);
    else if(1-percent==0.86)//when the user enters 14
      System.out.println("The proportion remaining is "+0.86);
    else if(1-percent==0.67)//when the user enters 33
      System.out.println("The proportion remaining is "+0.67);
    else if(1-percent==0.4)//when the user enters 60
